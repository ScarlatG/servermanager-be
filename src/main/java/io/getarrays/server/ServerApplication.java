...
public class ServerApplication {
    ...
    CommandLineRunner run(ServerRepository serverRepository) {
        return args -> {
            ...
            serverRepository.save(new Server(null, "192.168.1.58", "Fedora Linux", "16 GB", "Del Tower  ", "http://localhost:8080/server/image/server2.png", Status.SERVER_DOWN));
            ...
            serverRepository.save(new Server(null, "192.168.1.14", "Red Hat Enerprise Linux", "64 GB", "Mail Server", "http://localhost:8080/server/image/server4.png", Status.SERVER_DOWN));
        };
    }
